...
function add_css () {
    ...
    style.id = "svelte-852384429-style";
    style.textContent = "\n  [svelte-852384429].multicarousel, [svelte-852384429] .multicarousel {\n    position: relative;\n    overflow: hidden;\n    white-space: nowrap;\n  }\n  [svelte-852384429].previous, [svelte-852384429] .previous, [svelte-852384429].next, [svelte-852384429] .next, [svelte-852384429].pause, [svelte-852384429] .pause, [svelte-852384429].start, [svelte-852384429] .start {\n    position: absolute;\n    cursor: pointer;\n    display: flex;\n    z-index: 1;\n    fill: #fff;\n  }\n  [svelte-852384429].previous, [svelte-852384429] .previous, [svelte-852384429].next, [svelte-852384429] .next {\n    width: 30px;\n    align-items: center;\n    height: 100%;\n  }\n  [svelte-852384429].previous, [svelte-852384429] .previous {\n    left: 0;\n    justify-content: flex-end;\n  }\n  [svelte-852384429].next, [svelte-852384429] .next {\n    right: 0;\n    justify-content: flex-start;\n  }\n  [svelte-852384429].pause, [svelte-852384429] .pause, [svelte-852384429].start, [svelte-852384429] .start {\n    width: 28px;\n    left: 50%;\n    margin-left: -14px;\n    height: 30px;\n    bottom: 0;\n    justify-content: center;\n    align-items: flex-start;\n  }\n  [svelte-852384429].items, [svelte-852384429] .items {\n    white-space: nowrap;\n    position: relative;\n  }\n  [svelte-852384429].items > *, [svelte-852384429] .items > * {\n    display: none;\n  }\n  [svelte-852384429].items > *.active, [svelte-852384429] .items > *.active {\n    display: inline-block;\n  }\n";
    appendNode( style, document.head );
}

function create_main_fragment ( state, component ) {
    var div = createElement( 'div' );
    setAttribute( div, 'svelte-852384429', '' );
...
function MultiCarousel ( options ) {
    ...
    if ( !document.getElementById( "svelte-852384429-style" ) ) add_css();
